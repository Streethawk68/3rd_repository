...
SECRET_KEY = "django-insecure-d#lbvjvewgn=fh+_$po&$l7cx*jsz)+3@v)&c24u9j(@c-j8*g"
...
if config.is_valid_platform():
    ALLOWED_HOSTS.append('https://www.kgalt-branch-5d5txra-sn54dc7ygzqsm.us-3.platformsh.site')
    DEBUG = True
